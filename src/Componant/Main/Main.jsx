          ...
          <div className={` ${Style.allBtn} col-md-3  `}>
            <div className="d-flex  flex-md-column flex-wrap justify-content-center ">
              <button
                ...
                className={`${
                  currentActive === "all" ? Style.active : null
              ...
              <button
                ...
                className={`${
                  currentActive === "css" ? Style.active : null
                } $ btn ms-2 my-2 py-2 px-2 rounded-4`}
              >
                {" "}
                HTML And CSS
              ...
              <button
                ...
                className={`${
                  currentActive === "js" ? Style.active : null
                } $ btn ms-2 my-2 py-2 px-2 rounded-4`}
              >
                JavaScript
              </button>
              <button
                ...
                className={`${
                  currentActive === "jQuery" ? Style.active : null
                } $ btn ms-2 my-2 py-2 px-2 rounded-4`}
              >
                jQuery
              </button>
              <button
                ...
                className={`${
                  currentActive === "react" ? Style.active : null
                } $ btn ms-2 my-2 py-2 px-2 rounded-4`}
              >
                React.JS
              </button>
              ...
              <button
                ...
                className={`${
                  currentActive === "next" ? Style.active : null
                } $ btn ms-2 my-2 py-2 px-2 rounded-4`}
              >
                Next JS
              </button>
                ...
                arr.map((item) => (
                  <div key={item.id} className="col-md-6 d-flex  ">
                    <Fade direction="right" duration={1000}>
                      <Card
                        className={`${Style.cardStyle} mb-3 `}
                        key={item.id}
                      >
                        <Card.Img
                          variant="top"
